      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-left mb-8">
          <div>
            ...
            <a href="tel:+917020210426" className="block text-primary-600 font-bold md:text-lg hover:text-primary-700 transition-colors">+91 70202 10426</a>
            <a href="tel:+917304614767" className="block text-primary-600 font-bold md:text-lg hover:text-primary-700 transition-colors">+91 73046 14767</a>
            <p className="text-primary-600">lotusdentalcare01@gmail.com</p>
          </div>

          <div>
            <h3 className="font-bold text-primary-600 mb-2 md:text-lg">Open Hours</h3>
